...
def generate_ising_data(n_init, n_times, h, J, n_steps_equil, n_steps_final, n_prints, beta, seed):
    """
    ...
    reps = n_init * n_times
    samples = jnp.repeat(init_samples, repeats=n_times, axis=0)

    # 3. step: decorrelate copies
    n_samples = n_init * n_times
